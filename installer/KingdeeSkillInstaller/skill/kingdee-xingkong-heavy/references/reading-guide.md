...
```
{BASE_PATH}\星空帮助中心全量库\search\l1-routing.jsonl
```
...
用 Grep 工具直接搜索以下目录的所有分片文件（约 10 MB，可接受）：

```
{BASE_PATH}\星空帮助中心全量库\search\l2-shards\
```
...
```
{BASE_PATH}\星空帮助中心全量库\search\l2-shards\{shard_id}.jsonl
```
